...
pub fn compile_scoring_policy(
    ...
    let weights = ScoreWeights {
        ...
        reference_addition: rule_weight(document, "reference_addition"),
        category_addition: rule_weight(document, "category_addition"),
        interwiki_addition: rule_weight(document, "interwiki_addition"),
        mass_blanking: rule_weight(document, "mass_blanking"),
        inserted_profanity: rule_weight(document, "inserted_profanity"),
        repeated_character_noise: rule_weight(document, "repeated_character_noise"),
...
fn signal_from_slug(slug: &str) -> Result<ScoringSignal, ScoringPolicyError> {
    match slug {
        ...
        "reference_addition" => Ok(ScoringSignal::ReferenceAddition),
        "category_addition" => Ok(ScoringSignal::CategoryAddition),
        "interwiki_addition" => Ok(ScoringSignal::InterwikiAddition),
        "mass_blanking" => Ok(ScoringSignal::MassBlanking),
        "inserted_profanity" => Ok(ScoringSignal::InsertedProfanity),
        "repeated_character_noise" => Ok(ScoringSignal::RepeatedCharacterNoise),
