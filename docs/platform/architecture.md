...
| `sp42-fetch` | platform | [ADR-0013](adr/0013-layered-platform-domain-architecture.md), [ADR-0015](../domains/references/adr/0015-rules-compliant-read-only-fetch-edge.md), [ADR-0018](../domains/references/adr/0018-open-library-internet-archive-read-contract.md), [ADR-0019](../domains/references/adr/0019-open-library-apply-contract.md) | — |  |
...
| [ADR-0018](../domains/references/adr/0018-open-library-internet-archive-read-contract.md) | Open Library / Internet Archive read contract | Proposed | references | `sp42-fetch` |
| [ADR-0019](../domains/references/adr/0019-open-library-apply-contract.md) | Open Library apply contract (operator-confirmed enrichment writes) | Proposed | references | `sp42-fetch` |
...
| [PRD-0009](../domains/references/prd/0009-book-citation-grounding-and-open-library-enrichment.md) | Book-citation grounding and Open Library enrichment | Draft | references | ADR-0004, ADR-0006, ADR-0007, ADR-0009, ADR-0010, ADR-0011, ADR-0017, ADR-0018, ADR-0019 |
