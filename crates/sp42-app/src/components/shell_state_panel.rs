...
pub fn ShellStatePanel(model: ShellStateModel) -> impl IntoView {
    ...
    view! {
        <section
            style="display:grid;gap:10px;padding:17px;border-radius:6px;border:1px solid rgba(148,163,184,.2);background:rgba(8,16,30,.96);"
        >
            ...
            <article
                style="display:grid;gap:7px;padding:10px 17px;border-radius:4px;border:1px solid rgba(148,163,184,.16);background:rgba(15,23,42,.46);"
            >
                <div style="display:flex;align-items:center;justify-content:space-between;gap:7px;flex-wrap:wrap;">
