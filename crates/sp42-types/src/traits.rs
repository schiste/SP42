...
use crate::{
    EventSourceError, HttpClientError, HttpRequest, HttpResponse, ServerSentEvent, StorageError,
    WebSocketError, WebSocketFrame,
};
...
mod tests {
    ...
    use crate::{HttpMethod, HttpRequest, HttpResponse, ServerSentEvent, WebSocketFrame};
